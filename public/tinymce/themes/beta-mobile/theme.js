            ...
            items: [
              {
                dom: {
                  tag: 'span',
                  innerHtml: 'Mobile Theme: v' + '0.0.11-68'
                }
              }
            ]
          };
