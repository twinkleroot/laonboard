    ...
    <form role="form" method="POST" name="recaptchaForm" id="recaptchaForm" action="{{ route('admin.googlerecaptcha.update') }}">
        ...
        <section id="cfs_cert" class="adm_box">
            ...
            <table class="adm_box_table">
                ...
                <tr>
                    <th>
                        <label for="googleRecaptchaClient">클라이언트 키</label>
                    </th>
                    <td class="table_body">
                        <input type="text" class="form-control form_large" name="googleRecaptchaClient" value="" style="display: inline-block;">
                    <a href="https://www.google.com/recaptcha/admin" class="btn btn-sir ml15" target="_blank">키 얻기</a>
                    </td>
                </tr>
                <tr>
                    <th>
                        <label for="googleRecaptchaServer">서버 키</label>
                    </th>
                    <td class="table_body">
                        <input type="text" class="form-control form_large" name="googleRecaptchaServer" value="" style="display: inline-block;">
                    <a href="https://www.google.com/recaptcha/admin" class="btn btn-sir ml15" target="_blank">키 얻기</a>
                    </td>
                </tr>
            </table>
