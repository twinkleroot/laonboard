                    ...
                    <tr>
                        ...
                        <td class="td_nick">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="{{ route('user.mail.form')}}?to={{ $user->id }}&amp;name={{ $user->nick }}&amp;email= {{ encrypt($user->email) }}" class="winFormMail" target="_blank" onclick="winFormMail(this.href); return false;">메일보내기</a></li>
