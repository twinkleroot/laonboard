                        ...
                        @foreach ($users as $user)
                            <tr>
                                <td class="text-center">
                                    <input type="checkbox" name="id[]" class="userId" value='{{ $user->id }}' /></td>
                                <td class="text-center">{{ $user->email }}</td>
                                <td class="text-center">{{ $user->name }}</td>
                                <td class="text-center">{{ $user->nick }}</td>
                                {{-- <td class="text-center">{{ $user->email_certify }}</td> --}}
                                <td class="text-center">
                                    <input type='checkbox' name='open[]' class='open' value='1' {{ ($user->open == '1' ? 'checked' : '') }}/></td>
                                <td class="text-center">
                                    <input type='checkbox' name='mailing[]' class='mailing' value='1' {{ ($user->mailing == '1' ? 'checked' : '') }}/></td>
                                <td class="text-center">
                                    <input type='checkbox' name='sms[]' class='sms' value='1' {{ ($user->sms == '1' ? 'checked' : '') }}/></td>
                                {{-- <td class="text-center">
