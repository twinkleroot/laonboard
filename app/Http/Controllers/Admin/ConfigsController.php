...
class ConfigsController extends Controller
{
    ...
    public function rules()
    {
        return [
            ...
            'kakaoRedirect' => 'bail|regex:/^(((http(s?))\:\/\/)?)([0-9a-zA-Z\-]+\.)+[a-zA-Z]{2,6}(\:[0-9]+)?(\/\S*)?$/|nullable',
            'naverKey' => 'bail|alpha_dash|nullable',
            'naverSecret' => 'bail|alpha_dash|nullable',
            'naverRedirect' => 'bail|regex:/^(((http(s?))\:\/\/)?)([0-9a-zA-Z\-]+\.)+[a-zA-Z]{2,6}(\:[0-9]+)?(\/\S*)?$/|nullable',
            'facebookKey' => 'bail|alpha_dash|nullable',
            'facebookSecret' => 'bail|alpha_dash|nullable',
            'facebookRedirect' => 'bail|regex:/^(((http(s?))\:\/\/)?)([0-9a-zA-Z\-]+\.)+[a-zA-Z]{2,6}(\:[0-9]+)?(\/\S*)?$/|nullable',
            'googleSecret' => 'bail|alpha_dash|nullable',
            'googleRedirect' => 'bail|regex:/^(((http(s?))\:\/\/)?)([0-9a-zA-Z\-]+\.)+[a-zA-Z]{2,6}(\:[0-9]+)?(\/\S*)?$/|nullable',
