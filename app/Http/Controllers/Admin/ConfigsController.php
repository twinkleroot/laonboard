...
class ConfigsController extends Controller
{
    ...
    public function rules()
    {
        return [
            ...
            'kakaoRedirect' => 'bail|regex:'. config('gnu.URL_REGEX'). '|nullable',
            'naverKey' => 'bail|alpha_dash|nullable',
            'naverSecret' => 'bail|alpha_dash|nullable',
            'naverRedirect' => 'bail|regex:'. config('gnu.URL_REGEX'). '|nullable',
            'facebookKey' => 'bail|alpha_dash|nullable',
            'facebookSecret' => 'bail|alpha_dash|nullable',
            'facebookRedirect' => 'bail|regex:'. config('gnu.URL_REGEX'). '|nullable',
            'googleSecret' => 'bail|alpha_dash|nullable',
            'googleRedirect' => 'bail|regex:'. config('gnu.URL_REGEX'). '|nullable',
