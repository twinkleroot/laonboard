...
class ConfigController extends Controller
{
    ...
    public function rules()
    {
        return [
            ...
            'popularDel' => 'bail|numeric|required',
    ...
    public function messages()
    {
        return [
            ...
            'popularDel.required' => '인기검색어 삭제를 입력해 주세요.',
            'popularDel.numeric' => '인기검색어 삭제에는 숫자만 들어갈 수 있습니다.',
            ...
            'kakaoRedirect.url' => '카카오 Redirect URI에 http://를 포함한 url 형식으로 입력해 주세요.',
            ...
            'naverRedirect.url' => '네이버 Redirect URI에 http://를 포함한 url 형식으로 입력해 주세요.',
            ...
            'facebookRedirect.url' => '페이스북  Redirect URI에 http://를 포함한 url 형식으로 입력해 주세요.',
            'googleSecret.alpha_dash' => '구글 Secret은 문자, 숫자, 대쉬(-), 언더스코어(_)만 포함할 수 있습니다.',
            'googleRedirect.url' => '구글 Redirect URI에 http://를 포함한 url 형식으로 입력해 주세요.',
