...
class Board extends Model implements BoardInterface
{
    ...
    public function getBoardCreateParams($request)
    {
        ...
        $board = [
            ...
            'use_secret' => config('gnu.use_secret'),
            'count_modify' => config('gnu.count_modify'),
            'count_delete' => config('gnu.count_delete'),
            ...
            // 'gallery_cols' => 4,
            // 'gallery_width' => 174,
            'gallery_height' => config('gnu.gallery_height'),
            // 'mobile_gallery_width' => 125,
            // 'mobile_gallery_height' => 100,
            // 'table_width' => 100,
            'subject_len' => config('gnu.subject_len.default'),
            // 'mobile_subject_len' => 30,
            'new' => config('gnu.new'),
            'hot' => config('gnu.hot'),
            'image_width' => config('gnu.image_width'),
            'upload_count' => config('gnu.upload_count'),
            'upload_size' => config('gnu.upload_size'),
            'reply_order' => config('gnu.reply_order'),
            'use_search' => config('gnu.use_search'),
            'content_head' => config('gnu.content_head'),
            'content_tail' => config('gnu.content_tail'),
            'insert_content' => config('gnu.insert_content'),
        ];
